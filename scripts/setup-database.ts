...
const orderCollectionSchemas: CollectionSchema[] = [
  {
    ...
    attributes: [
      ...
      { key: "deliveryDistanceMeters", type: "integer", required: false, min: 0 },
      { key: "deliveryDurationSeconds", type: "integer", required: false, min: 0 },
      { key: "deliveryPricingVersion", type: "string", size: 50, required: false },
